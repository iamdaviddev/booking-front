            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              <Card className="shadow-md hover:shadow-lg transition-shadow">
                <Link className="block" href="#">
                  ...
                  <CardContent className="p-4">
                    <h3 className="text-lg font-semibold mb-2">Deluxe</h3>
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow">
                <Link className="block" href="#">
                  ...
                  />
                  <CardContent className="p-4">
                    <h3 className="text-lg font-semibold mb-2">Hotel Oasis</h3>
                    <div className="flex items-center mb-2">
                      <StarIcon className="w-5 h-5 text-yellow-500" />
                      <span className="ml-1 text-gray-600 dark:text-gray-400">4.6</span>
                      <span className="ml-2 text-gray-600 dark:text-gray-400">(92 reviews)</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Relax in our tranquil oasis, just minutes from the beach.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-primary font-semibold">$199/night</span>
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow">
                <Link className="block" href="#">
                  ...
                  />
                  <CardContent className="p-4">
                    <h3 className="text-lg font-semibold mb-2">Hotel Skyline</h3>
                    <div className="flex items-center mb-2">
                      <StarIcon className="w-5 h-5 text-yellow-500" />
                      <span className="ml-1 text-gray-600 dark:text-gray-400">4.7</span>
                      <span className="ml-2 text-gray-600 dark:text-gray-400">(105 reviews)</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Tenha as melhores vistas da cidade.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-primary font-semibold">$179/night</span>
                      <Button variant="outline">Book Now</Button>
                    </div>
                  </CardContent>
                </Link>
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow">
                <Link className="block" href="#">
                  ...
                  />
                  <CardContent className="p-4">
                    <h3 className="text-lg font-semibold mb-2">Hotel Serenity</h3>
                    <div className="flex items-center mb-2">
                      <StarIcon className="w-5 h-5 text-yellow-500" />
                      <span className="ml-1 text-gray-600 dark:text-gray-400">4.9</span>
                      <span className="ml-2 text-gray-600 dark:text-gray-400">(142 reviews)</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      Escape to our peaceful retreat, perfect for a relaxing getaway.
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-primary font-semibold">$229/night</span>
                      <Button variant="outline">Book Now</Button>
                    </div>
                  </CardContent>
                </Link>
